...
interface EnhancedTableProps {
  numSelected: number;
  onRequestSort: (event: React.MouseEvent<unknown>, property: keyof SavedWorkFLowItem) => void;
...
function EnhancedTableHead(props: EnhancedTableProps) {
  ...
  const createSortHandler =
    (property: keyof SavedWorkFLowItem) => (event: React.MouseEvent<unknown>) => {
...
export default function SavedWorkFlows() {
  ...
  const handleRequestSort = (
    ...
    property: keyof SavedWorkFLowItem,
  ) => {
                ...
                return (
                  ...
                  >
                    <TableCell
                      ...
                      scope="row"
                    >
                      <div onClick={() => navigate('../build/metadata/saved/'+row.entryid)}>
                        {row.id}
                      </div>
                    </TableCell>
                    ...
                    <TableCell align="right">
                      <Stack direction="column" spacing={2}>
                        ...
                        <Button variant="outlined" onClick={() => navigate('../build/metadata/saved/'+row.entryid)}>Edit</Button>
                      </Stack>
                    </TableCell>
                  </TableRow>
                );

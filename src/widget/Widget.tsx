...
export default function Widget() {
  ...
  let relativePath = ''
  if (env == "PROD"){
    relativePath = configData.RELATIVEPATH['PROD'];
  }
  else if (env == "DEV"){
    relativePath = configData.RELATIVEPATH['DEV'];
  }
  else{
    relativePath = configData.RELATIVEPATH['LOC'];
  }

  const router = createBrowserRouter(
    createRoutesFromElements(
      <Route path={relativePath} element={<BaseLayout />} errorElement={<WorkFlowError /> }>
        <Route index element={<Home />} />
        {/* <Route path="/widget" element={<Home />} errorElement={<WorkFlowError /> } /> */}
